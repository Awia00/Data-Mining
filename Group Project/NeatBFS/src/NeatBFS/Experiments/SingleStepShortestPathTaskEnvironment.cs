...
{
    public class SingleStepShortestPathTaskEnvironment : BaseEnvironment
    {
        #region environment
        ...
        public SingleStepShortestPathTaskEnvironment(IShortestPathInstanceFactory instanceFactory)
        {
