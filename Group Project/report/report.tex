...
In \todo{cite entm} Risi et. al. introduces the Evolvable Neural Turing Machine. A Neural Turing Machine is able to write and read weights of a non-fixed size memory tape like a regular turing machine. Risi. et. al. shows that the evolvable neural turing machine are able to solve simple algorithm tasks such as the copy task, and T-maze task. 
