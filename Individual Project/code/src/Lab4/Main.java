...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (KMedoidCluster foundClustersKMedoid : foundClustersKMedoids) {
            System.out.println(clusterPuritySuite.checkCluster(foundClustersKMedoid.points.stream().map(nDimensionalPoint -> (ClassifiablePoint<Nominal>) nDimensionalPoint).collect(Collectors.toList())));
